...
export const CursoCard: React.FC<{ curso: Curso }> = ({ curso }) => {
  ...
  return (
    <div className="bg-[#191917] border border-transparent hover:border-amber-50/35 w-full h-fit gap-3 flex flex-col items-start justify-between px-[24px] py-[18px] rounded-[10px]">
      {/* Course Info */}
      ...
      <div className="flex gap-[5px] items-center w-full">
        <div className="bg-[#ff4545] rounded-full p-[2px] flex items-center justify-center">
      ...
      {/* Progress Bar */}
      <div className="flex gap-[10px] items-center w-[218px]">
